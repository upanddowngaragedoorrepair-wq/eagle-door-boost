    ...
    <section className="py-8 md:py-10 bg-[hsl(var(--navy))] relative overflow-hidden">
      <div className="container-main relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-center p-4 rounded-xl bg-white/[0.07] border border-white/10 backdrop-blur-sm">
            <img
              src={cslbBadge}
              alt="CSLB Contractors State License Board - LIC#1138855"
              className="w-full h-full max-h-28 md:max-h-36 object-contain"
              loading="lazy"
              decoding="async"
            />
          </div>
