...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-32 pb-16">
      {/* Background Image with Overlay - LCP optimized with explicit dimensions */}
      <img 
        src={heroBg} 
        alt="" 
        fetchPriority="high"
      ...
      <div className="container-main relative">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 mb-8 animate-fade-in-up" style={{ animationDelay: '0ms' }}>
          {/* Rating Badge */}
        ...
        {/* Main Headline - RENDERS IMMEDIATELY for LCP (removed animate-on-load) */}
