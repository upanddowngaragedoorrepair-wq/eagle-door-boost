...
const badges = [
  ...
  },
  {
    icon: DollarSign,
    title: 'Clear Pricing',
    description: 'Upfront before work begins',
  },
];
      ...
      <div className="container-main">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
          {badges.map((badge, index) => (
            <div
              key={index}
              className="trust-badge group hover:border-primary/30 transition-all duration-300"
            >
              <div className="trust-icon group-hover:scale-110 transition-transform duration-300">
