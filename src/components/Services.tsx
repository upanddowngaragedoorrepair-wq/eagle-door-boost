      ...
      <div className="container-main relative">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-6 tracking-tight">
            ...
            <span className="text-foreground">These are only some of our most recent installations.
We offer many additional styles, access control systems, and custom configurations not shown. Call Now To see More Design Options                 </span>
          </h2>
