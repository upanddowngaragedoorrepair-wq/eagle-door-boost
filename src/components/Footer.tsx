        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-14 mb-14">
          ...
          <div>
            ...
            >
              ...
              <div>
                <h3 className="font-display text-2xl font-bold text-foreground uppercase">Eagle Automatic</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-display font-bold text-lg text-foreground mb-6 uppercase tracking-wide">Quick Links</h4>
            <ul className="space-y-3 text-muted-foreground">
              <li>
                <a href="#services" onClick={(e) => { e.preventDefault(); document.querySelector('#services')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-primary transition-colors cursor-pointer">
                  Services
                </a>
              </li>
              <li>
                <a href="#reviews" onClick={(e) => { e.preventDefault(); document.querySelector('#reviews')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-primary transition-colors cursor-pointer">
                  Reviews
                </a>
              </li>
              <li>
                <a href="#service-area" onClick={(e) => { e.preventDefault(); document.querySelector('#service-area')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-primary transition-colors cursor-pointer">
                  Service Area
                </a>
              </li>
              <li>
                <a href="#quote-form" onClick={(e) => { e.preventDefault(); document.querySelector('#quote-form')?.scrollIntoView({ behavior: 'smooth' }); }} className="hover:text-primary transition-colors cursor-pointer">
                  Free Estimate
                </a>
              </li>
            </ul>
