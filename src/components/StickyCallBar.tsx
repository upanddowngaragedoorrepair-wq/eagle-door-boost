    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden sticky-bar-enter">
        <div className="bg-[hsl(var(--navy))] border-t-2 border-[hsl(var(--gold-bright))]/70 px-3 pt-2.5 pb-3 shadow-lg">
          <a
            ...
            className="btn-cta w-full text-lg py-3 min-h-[56px]"
          >
            <Phone className="w-5 h-5" />
            Call {phoneFormatted}
          </a>
          <p className="flex items-center justify-center gap-2 text-[11px] font-semibold text-white/90 mt-1.5 uppercase tracking-wider">
      ...
      <div className="hidden md:block fixed bottom-6 right-6 z-50 sticky-bar-enter">
        <a
          ...
          className="btn-cta text-lg min-h-[60px] px-7 flex-col !gap-0 items-start"
        >
          <span className="flex items-center gap-2.5">
            <Phone className="w-5 h-5" />
            {phoneFormatted}
          </span>
          <span className="text-[10px] font-semibold tracking-widest opacity-90">
