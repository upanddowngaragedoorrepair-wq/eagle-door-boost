...
export function PromiseBadges() {
  return (
    <section className="py-10 md:py-14 border-t border-b border-border bg-secondary/30">
      <div className="container-main">
        <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
          {badges.map((badge, i) => (
            <div key={i} className="flex items-center gap-2 px-5 py-3 rounded-full bg-card border border-border shadow-lg">
