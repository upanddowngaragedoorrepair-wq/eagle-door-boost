    ...
    <section className="py-20 md:py-28 bg-background">
      <div className="container-main">
        ...
        <p className="text-center text-muted-foreground mb-8">
          Present coupon to technician for instant savings.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-10 max-w-4xl mx-auto">
          {coupons.map((coupon, index) => (
            <a
              key={index}
              href={phoneLink}
              className="group relative aspect-[4/3] rounded-2xl overflow-hidden border-2 border-dashed border-primary/50 hover:border-primary transition-all duration-300"
            >
              <img 
                src={coupon.image} 
                alt={coupon.label}
