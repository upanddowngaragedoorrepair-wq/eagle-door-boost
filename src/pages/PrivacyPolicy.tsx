      ...
      <main className="pt-32 pb-20">
        <div className="container-main max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">3. Information Sharing</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">4. Cookies & Tracking</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">5. Data Security</h2>
            ...
            <section>
              ...
              <p>If you have any questions about this Privacy Policy, please contact us at {phoneFormatted} or email us at info@eaglegate.com.</p>
            </section>
          </div>
        </div>
      </main>
