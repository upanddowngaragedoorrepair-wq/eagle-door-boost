      ...
      <main className="pt-32 pb-20">
        <div className="container-main max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground/80 space-y-6">
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">2. Services</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">3. Estimates & Pricing</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">4. Warranty</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">5. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="font-display text-xl font-bold text-foreground mt-8 mb-3">7. Licensing</h2>
            ...
            <section>
              ...
              <p>If you have any questions about these Terms of Service, please contact us at {phoneFormatted} or email us at office@eagleautomaticgate.com.</p>
            </section>
          </div>
        </div>
      </main>
